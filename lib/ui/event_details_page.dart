...
class EventDetailsPage extends StatelessWidget {
  ...
  const EventDetailsPage({Key key, @required this.event})
      : assert(event != null, "Please pass a movie as an argument"),
        super(key: key);
  ...
  goToEventList(BuildContext context) {
    Navigator.pushNamed(context, Routes.ROUTE_MAIN);
  }
